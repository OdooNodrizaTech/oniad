                ...
                for message in response['Messages']:
                    ...
                    if result_message['statusCode'] == 200:
                        ...
                        if 'oniad_country_id' in data_oniad_country_state:
                            if data_oniad_country_state['oniad_country_id'] > 0:
                                oniad_country_ids = self.env['oniad.country'].search(
                                    [
                                        ('id', '=', int(data_oniad_country_state['oniad_country_id']))
                                    ]
                                )
                                if oniad_country_ids:
                                    ...
                                    result_message['statusCode'] = 500
                                    result_message['return_body'] = _('Country_id=%s does not exist') % data_oniad_country_state['oniad_country_id']
                        # add_id
                        ...
                        if previously_found == False:
                            ...
                            self.env['oniad.country.state'].sudo().create(data_oniad_country_state)
                    # final_operations
